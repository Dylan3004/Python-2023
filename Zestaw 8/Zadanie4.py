...
# Ustawienie widżetów przy użyciu grid
open_bnt.grid(row=0, column=0, padx=10)
width_label.grid(row=0, column=1, padx=10)
width_entry.grid(row=0, column=2, padx=10)
height_label.grid(row=0, column=3, padx=10)
height_entry.grid(row=0, column=4, padx=10)
resize_btn.grid(row=0, column=5, padx=10)
